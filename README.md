...
- Il faut donc que vous passiez la bonne commande avec un PID qui existe pour trouver le fichier de configuration, vous devez donc savoir dans quel dossier vous êtes actuellement (en n'oubliant pas les url encode) : http://localhost:8081/admin/procPerf?pid=XXX%26%26whoami%26%26REM
    - Vous constatez que vous vous trouvez vraisemblablement dans le dossier courant du serveur
    - Vous exécutez donc la commande permettant d'afficher le fichier de configuration dans son répertoire classique (en n'oubliant pas les url encode) : http://localhost:8081/admin/procPerf?pid=XXXPerfCounter.print%26%26type%20src%5Cmain%5Cresources%5Capplication.properties%26%26REM
