...
# Cas 05 : Lib malveillante commons-text

Vous allez enfin exploiter une faille d'une librairie malveillante.
...
- Vous modifiez la description pour passer un dns interpolator
...
- Ici c'est assez simple, il faut mettre à jour vos dépendances ! Commons-text est vulnérable jusqu'à la version 1.9, il faut mettre une version supérieure.
- De plus l'utilisation d'une librairie comme apache commons-jexl3 peut ouvrir une porte critique sur votre application, il ne faut l'utiliser que si vraiment vous n'avez pas d'autres choix, et verrouiller tous les accès depuis l'extérieur